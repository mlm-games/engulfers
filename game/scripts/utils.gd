...
static func spawn_at_pos(emitter: BaseVoidEntity, scene := C.Projectiles.PlayerVoidProjectile, global_pos: Vector2 = emitter.global_position, global_rot: float = emitter.global_rotation) -> VoidProjectile:
